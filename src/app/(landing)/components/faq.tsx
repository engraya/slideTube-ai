      ...
      <ul>
        <li className="text-left mb-10">
          <div className="flex flex-row items-start mb-5">
            ...
            <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
              <h4 className="text-md leading-6 font-medium text-gray-900">How does SlideTube-AI work?</h4>
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
              <p className="text-gray-700 text-sm">SlideTube-AI uses advanced machine learning algorithms to analyze YouTube videos, extracting key content, summarizing information, and creating slides based on the video’s main points.
              </p>
            </div>
        ...
        <li className="text-left mb-10">
          <div className="flex flex-row items-start mb-5">
            ...
            <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
              <h4 className="text-md leading-6 font-medium text-gray-900">What types of videos can I use?</h4>
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
              <p className="text-gray-700 text-sm">You can use any publicly available YouTube video. Simply paste the video URL into SlideTube-AI, and our AI will handle the rest!
              </p>
            </div>
            <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
              <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
        ...
        <li className="text-left mb-10">
          <div className="flex flex-row items-start mb-5">
            ...
            <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
              <h4 className="text-md leading-6 font-medium text-gray-900">Is there a limit to how many presentations I can create?</h4>
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
              <p className="text-gray-700 text-sm">Our free plan offers limited access to features. For unlimited presentations and premium features, consider upgrading to one of our paid plans.
              </p>
            </div>
            <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
              <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
        ...
        <li className="text-left mb-10">
          <div className="flex flex-row items-start mb-5">
            ...
            <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
              <h4 className="text-md leading-6 font-medium text-gray-900">Can I edit the presentations after they are generated?</h4>
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
              <p className="text-gray-700 text-sm">Yes! Once your presentation is generated, you can edit, customize, and fine-tune it in our easy-to-use editor.
              </p>
            </div>
            <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
              <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
        ...
        <li className="text-left mb-10">
          <div className="flex flex-row items-start mb-5">
            ...
            <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
              <h4 className="text-md leading-6 font-medium text-gray-900">Can I export my presentations to PowerPoint or Google Slides?</h4>
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
              <p className="text-gray-700 text-sm">Absolutely! You can export your presentation to PowerPoint, Google Slides, or PDF formats for easy sharing and presentation.
              </p>
            </div>
            <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
              <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
        ...
        <li className="text-left mb-10">
          <div className="flex flex-row items-start mb-5">
            ...
            <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
              <h4 className="text-md leading-6 font-medium text-gray-900">Is SlideTube-AI free to use?</h4>
            </div>
          </div>
          <div className="flex flex-row items-start">
            <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
              <p className="text-gray-700 text-sm">We offer a free trial that lets you explore the core features. To access premium features and unlimited presentations, you’ll need to subscribe to a paid plan.
              </p>
            </div>
            <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
              <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
